...
# print(Y_train)
train = df_stock_info.loc[maxlength-240:maxlength-61, ['low']]
test = df_stock_info.loc[maxlength-60:, ['low']]
...
history = model.fit(X_train_t, Y_train, epochs=1000, verbose=1, batch_size=20, validation_data=(X_test_t, Y_test), callbacks=[early_stop])
...
plt.legend(["Y_test", "Y_pred_by_low"])
